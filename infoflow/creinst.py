...
Docs: https://Hopsakee.github.io/infoflow/create_instances.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_create_instances.ipynb.

# %% auto #0
__all__ = ['tools_from_code', 'informationitems_from_code', 'db_from_instances']
...
# %% ../nbs/01_create_instances.ipynb #1c94ce7f
...
# %% ../nbs/01_create_instances.ipynb #4f6ee752
def db_from_instances(
    ...
    dbclose: bool = True, # Whether to close the database connection after creating the database
    ) -> Database | None:
